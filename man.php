        ...
        <div id="page-wrapper">
			...
			<?php   
					...
					while ($nms = mysqli_fetch_array($names)) {
						...
						$df = $nam['user_id'] ;
						echo strtoupper($user_name)." ".strtoupper($unm)."<form method='POST' class='inline-form' ><button type='submit'  class='btn-primary'  name='see_all_message'  >See all messages </button>
